[
    {
      ...
      "opcoes": [
        { "letra": "a", "texto": "2 minutos", "correta": false },
        { "letra": "b", "texto": "3 minutos", "correta": false },
        { "letra": "c", "texto": "4 minutos", "correta": true },
        { "letra": "d", "texto": "9 minutos", "correta": false }
      ],
    ...
    },
    {
      ...
      "opcoes": [
        { "letra": "a", "texto": "2, 6, 10, 14 e 18", "correta": false },
        { "letra": "b", "texto": "10, 14 e 18", "correta": false },
        { "letra": "c", "texto": "Nenhuma porque a chave não existe no vetor", "correta": false },
        { "letra": "d", "texto": "10, 14 e 12", "correta": true }
      ],
    ...
    },
    {
      ...
      "opcoes": [
        { "letra": "a", "texto": "Apenas I é verdadeira", "correta": true },
        { "letra": "b", "texto": "Apenas II é verdadeira", "correta": false },
        { "letra": "c", "texto": "Apenas III é verdadeira", "correta": false },
        { "letra": "d", "texto": "Apenas I e II são verdadeiras", "correta": false }
      ],
    ...
    },
    {
      ...
      "opcoes": [
        { "letra": "a", "texto": "A diferença de altura da subárvore esquerda para a subárvore direita não exceda de 1, e as subárvores esquerda e direita também são balanceadas.", "correta": true },
        { "letra": "b", "texto": "Todos os nós da árvore têm 0 ou 2 subárvores, e a altura mínima da raiz é 2.", "correta": false },
        { "letra": "c", "texto": "Não existe diferença entre as alturas das subárvores dos nós.", "correta": false },
        { "letra": "d", "texto": "Todos os nós com chaves de busca menores que a chave da raiz encontram-se na subárvore esquerda.", "correta": false }
      ],
    ...
    },
    {
      ...
      "opcoes": [
        { "letra": "a", "texto": "void insere (Lista *lista, int info) { ... }", "correta": false },
        { "letra": "b", "texto": "void insere (Lista *lista, int info) { ... }", "correta": false },
        { "letra": "c", "texto": "void insere (Lista **lista, int info) {\n  Lista *novo = malloc(sizeof (Lista));\n  novo->info = info;\n  novo->prox = *lista;\n  *lista = novo;\n}", "correta": true },
        { "letra": "d", "texto": "void insere (Lista **lista, int info) { ... }", "correta": false }
      ],
    ...
    },
    {
      ...
      "opcoes": [
        { "letra": "a", "texto": "Todas as afirmações são verdadeiras", "correta": false },
        { "letra": "b", "texto": "Apenas I e II são verdadeiras", "correta": false },
        { "letra": "c", "texto": "Apenas I e III são verdadeiras", "correta": true },
        { "letra": "d", "texto": "Apenas II e III são verdadeiras", "correta": false }
      ],
    ...
    },
    {
      ...
      "opcoes": [
        ...
        { "letra": "c", "texto": "9", "correta": true },
        { "letra": "d", "texto": "15", "correta": false }
      ],
    ...
    },
    {
      ...
      "opcoes": [
        { "letra": "a", "texto": "Apenas a afirmação I", "correta": false },
        { "letra": "b", "texto": "Apenas as afirmações I e II", "correta": true },
        { "letra": "c", "texto": "Apenas as afirmações II e III", "correta": false },
        { "letra": "d", "texto": "Todas as afirmações", "correta": false }
      ],
    ...
    },
    {
      ...
      "opcoes": [
        { "letra": "a", "texto": "Todo nó vermelho (rubro) tem dois filhos pretos", "correta": true },
        { "letra": "b", "texto": "A diferença de altura da subárvore esquerda para a subárvore direita não exceda de 1, e as subárvores esquerda e direita também são balanceadas", "correta": false },
        { "letra": "c", "texto": "Todo nó preto (negro) tem, pelo menos, uma subárvore cuja raiz é vermelha (rubra)", "correta": false },
        { "letra": "d", "texto": "A altura das subárvores é o fator usado para determinar o balanceamento, e pode exceder em 50% a diferença entre elas.", "correta": false }
      ],
    ...
    },
    {
      ...
      "opcoes": [
        { "letra": "a", "texto": "de, no máximo, n*log(n)", "correta": false },
        { "letra": "b", "texto": "de, no máximo, 2*log(n+1)", "correta": true },
        { "letra": "c", "texto": "no pior caso, n*n", "correta": false },
        { "letra": "d", "texto": "de, no máximo, log(n-1)", "correta": false }
      ],
    ...
    },
    {
      ...
      "opcoes": [
        { "letra": "a", "texto": "Uma pilha segue o princípio FIFO (First In, First Out), enquanto uma fila segue o princípio LIFO (Last In, First Out).", "correta": false },
        { "letra": "b", "texto": "Uma pilha segue o princípio LIFO (Last In, First Out), enquanto uma fila segue o princípio FIFO (First In, First Out).", "correta": true },
        { "letra": "c", "texto": "Pilhas e filas funcionam da mesma forma, não há diferença entre elas.", "correta": false },
        { "letra": "d", "texto": "Pilhas e filas não são estruturas de dados comuns na programação.", "correta": false }
      ],
    ...
    },
    {
      ...
      "opcoes": [
        { "letra": "a", "texto": "O endereço de memória do primeiro elemento do vetor", "correta": true },
        { "letra": "b", "texto": "O endereço de memória do primeiro e do último elemento do vetor", "correta": false },
        { "letra": "c", "texto": "Os valores dos elementos do vetor", "correta": false },
        { "letra": "d", "texto": "O número de elementos na memória do vetor", "correta": false }
      ],
    ...
    },
    {
      ...
      "opcoes": [
        { "letra": "a", "texto": "15, 105, 28, 3", "correta": false },
        { "letra": "b", "texto": "28, 45, 91, 21", "correta": false },
        { "letra": "c", "texto": "36, 21, 15, 45", "correta": true },
        { "letra": "d", "texto": "36, 55, 78, 45", "correta": false }
      ],
    ...
    },
    {
      ...
      "opcoes": [
        { "letra": "a", "texto": "#include<stdio.h>\nint main(void) {\n  float PT, E;\n  printf(\"Informe o valor\");\n  scanf(\"%f\",&E);\n  PT=E+E*1.18;\n  printf(\"Valor Total: %.2f\", PT);\n  return 0;\n}", "correta": false },
        { "letra": "b", "texto": "#include<stdio.h>\nint main(void) {\n  float X, TG;\n  printf(\"Informe o valor\");\n  scanf(\"%f\",&X);\n  TG=X*0.18;\n  printf(\"Valor Total: %.2f\", TG);\n  return 0;\n}", "correta": false },
        { "letra": "c", "texto": "#include<stdio.h>\nint main(void) {\n  float K, W;\n  printf(\"Informe o valor\");\n  scanf(\"%f\",&K);\n  W=K+K*0.18;\n  printf(\"Valor Total: %.2f\", W);\n  return 0;\n}", "correta": true },
        { "letra": "d", "texto": "#include<stdio.h>\nint main(void) {\n  float PT, E;\n  printf(\"Informe o valor\");\n  scanf(\"%f\",&E);\n  PT=E*E*18/100;\n  printf (\"Valor Total: %.2f\", PT);\n  return 0;\n}", "correta": false }
      ],
